...
public class neo4jBigData {

public static void main(String[] args) throws IOException{
		
		BatchInserter inserter = BatchInserters.inserter(new File("socialnet(neo4jBigData)"));
		...
		for(int i = 0; i < 100; i++){
			...
			attributesSandra.put("firstName", "Sandra"+i+"");
			attributesSandra.put("worksAt", "Amazon");
			attributesSandra.put("recommended", "true");
			
			// Bob works at IBM and will recommend Sandra
			
			attributesBob.put("firstName", "Bob"+i+"");
			attributesBob.put("worksAt", "IBM");
		}
